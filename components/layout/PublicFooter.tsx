          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-12 sm:gap-8">
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/about" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Our DNA Statement</Link></li>
                <li><Link href="/sermons" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Sermon Outlines</Link></li>
                <li><Link href="/scriptures" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Scripture Meditations</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link href="/events" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Events Calendar</Link></li>
                <li><Link href="/ministries" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Ministries</Link></li>
                <li><Link href="/prayer" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Prayer Center Feed</Link></li>
                <li><Link href="/register" className="text-sm font-semibold text-slate-400 hover:text-white transition-colors">Join Church Registry</Link></li>
              </ul>
            </div>
